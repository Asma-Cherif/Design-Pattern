...
// Thread-safe Singleton using EARLY INITIALIZATIOJ
class ThreadSafeSingleton {
    // Early instantiaction ensures the singleton is a class variable initialized when class is loaded
...
public class SingletonThreadSafetyDemo {
    ...
    private static void testThreadSafeSingletonEarlyInstantiation() {
